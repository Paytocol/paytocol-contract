...
import "src/library/TypedMemView.sol";
...
library BurnMessage {
    ...
    // 4 byte version + 32 bytes burnToken + 32 bytes mintRecipient + 32 bytes
    // amount + 32 bytes messageSender
    ...
    function _formatMessage(
        ...
        return abi.encodePacked(
            _version, _burnToken, _mintRecipient, _amount, _messageSender
        );
    }
