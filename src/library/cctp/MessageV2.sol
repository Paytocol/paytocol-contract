...
library MessageV2 {
     ...
     * @param _destinationCaller Address of caller on destination chain as
     * bytes32
     * @param _minFinalityThreshold the minimum finality at which the message
     * should be attested to
    ...
    function _getSourceDomain(bytes29 _message)
        internal
        pure
        returns (uint32)
    {
    ...
    function _getDestinationDomain(bytes29 _message)
        internal
        pure
        returns (uint32)
    {
    ...
    function _getDestinationCaller(bytes29 _message)
        internal
        pure
        returns (bytes32)
    {
    ...
    function _getMinFinalityThreshold(bytes29 _message)
        internal
        pure
        returns (uint32)
    {
    ...
    function _getFinalityThresholdExecuted(bytes29 _message)
        internal
        pure
        returns (uint32)
    {
    ...
    function _getMessageBody(bytes29 _message)
        internal
        pure
        returns (bytes29)
    {
        return _message.slice(
            MESSAGE_BODY_INDEX, _message.len() - MESSAGE_BODY_INDEX, 0
        );
    }
    ...
    function _validateMessageFormat(bytes29 _message) internal pure {
        ...
        require(
            _message.len() >= MESSAGE_BODY_INDEX, "Invalid message: too short"
        );
    }
}
